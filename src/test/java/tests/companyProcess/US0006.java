...
public class US0006  {
    ...
    //update the name
    @Test(description =" update the name " )
    ...
    //Update the email
    @Test(dependsOnMethods = "TC0006_03")
    public void TC0006_05(){
        ...
        ReusableMethods.waitFor(2);
        //change the email field  with faker class
